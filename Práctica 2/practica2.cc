...
_ply_triangles model_ply_octahedron("octahedron.ply");

_rotacion peon(model_ply_peon.vertices,30);
_rotacion octahedron(model_ply_octahedron.vertices,5);
...
void draw_objects(){
	...
	switch(modelo){
		...
		switch (modo){
				case 1: //Puntos
					octahedron.draw_puntos(1,0,1,3);
					break;
				case 2: //Aristas
					octahedron.draw_aristas(1,0,1,2);
					break;
				case 3: //Solido
					octahedron.draw_solido(1,0,1);
					break;
				case 4: //Ajedrez
					octahedron.draw_solido_ajedrez(1,0,1,0,0,1);
					break;
			}
		break;
	}
...
void normal_keys(unsigned char Tecla1,int x,int y)
{
	...
	switch (toupper(Tecla1)) {
				...
				case '5': modelo=5; break; //octahedron
	}
